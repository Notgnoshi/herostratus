...
[06-persistence.md](/docs/design/06-persistence.md).
...
[08-performance-considerations.md](/docs/design/08-performance-considerations.md) for an approach
that hopefully reduces the performance impact of diffing commits. Other achievements though, might
care just about the commit message, which is far cheaper to access.
